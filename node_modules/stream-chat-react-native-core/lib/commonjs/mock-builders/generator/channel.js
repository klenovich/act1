...
var getChannelDefaults = function getChannelDefaults() {
  ...
  return {
    ...
    data: {
      cid: type + ":" + id,
      config: (0, _extends3["default"])({}, defaultConfig, {
        name: type,
        type: type
      }),
...
var generateChannel = function generateChannel(customValues) {
  return Object.keys(customValues).reduce(function (accumulated, current) {
    ...
    return (0, _extends3["default"])({}, accumulated, (0, _defineProperty2["default"])({}, current, customValues[current]));
  }, getChannelDefaults());
};
...
var generateChannelResponse = function generateChannelResponse() {
  ...
  return (0, _extends3["default"])({
    channel: (0, _extends3["default"])({}, defaults.data, (0, _extends3["default"])({
      cid: type + ":" + id
    }, channel, {
      id: id,
      type: type,
