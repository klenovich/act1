...
var MessagePinnedHeaderWithContext = function MessagePinnedHeaderWithContext(props) {
  ...
  }, _react["default"].createElement(_icons.PinHeader, {
    pathFill: grey,
    __self: _this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, t('Pinned by'), ' ', (message == null ? void 0 : (_message$pinned_by = message.pinned_by) == null ? void 0 : _message$pinned_by.id) === (client == null ? void 0 : (_client$user = client.user) == null ? void 0 : _client$user.id) ? t('You') : message == null ? void 0 : (_message$pinned_by2 = message.pinned_by) == null ? void 0 : _message$pinned_by2.name));
};
...
var MessagePinnedHeader = function MessagePinnedHeader(props) {
  ...
  return _react["default"].createElement(MemoizedMessagePinnedHeader, (0, _extends2["default"])({
    alignment: alignment,
