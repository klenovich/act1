...
var useCreateChannelsContext = function useCreateChannelsContext(_ref) {
  ...
  var channelValueString = channels == null ? void 0 : channels.map(function (channel) {
    ...
    return "" + ((_channel$data$name = (_channel$data = channel.data) == null ? void 0 : _channel$data.name) != null ? _channel$data$name : '') + ((_channel$id = channel.id) != null ? _channel$id : '') + Object.values(channel.state.members).map(function (member) {
      var _member$user;
