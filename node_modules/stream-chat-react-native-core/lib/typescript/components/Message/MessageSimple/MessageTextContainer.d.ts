...
export declare type MessageTextProps<StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics> = MessageTextContainerProps<StreamChatGenerics> & {
...
export declare type MessageTextContainerProps<StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics> = Partial<MessageTextContainerPropsWithContext<StreamChatGenerics>>;
