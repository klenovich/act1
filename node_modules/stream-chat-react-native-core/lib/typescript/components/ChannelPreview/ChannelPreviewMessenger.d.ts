...
export declare type ChannelPreviewMessengerPropsWithContext<StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics> = Pick<ChannelPreviewProps<StreamChatGenerics>, 'channel'> & Pick<ChannelsContextValue<StreamChatGenerics>, 'maxUnreadCount' | 'onSelect' | 'PreviewAvatar' | 'PreviewMessage' | 'PreviewMutedStatus' | 'PreviewStatus' | 'PreviewTitle' | 'PreviewUnreadCount'> & {
    /**
...
export declare type ChannelPreviewMessengerProps<StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics> = Partial<Omit<ChannelPreviewMessengerPropsWithContext<StreamChatGenerics>, 'channel' | 'latestMessagePreview'>> & Pick<ChannelPreviewMessengerPropsWithContext<StreamChatGenerics>, 'channel' | 'latestMessagePreview'>;
/**
