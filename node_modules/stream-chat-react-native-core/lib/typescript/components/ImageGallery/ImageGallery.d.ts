...
export declare type ImageGalleryCustomComponents<StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics> = {
    /**
...
export declare type Photo<StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics> = {
    id: string;
    uri: string;
    channelId?: string;
